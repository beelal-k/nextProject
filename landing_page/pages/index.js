    ...
    <>
      <Container maxWidth="" className={styles.firstSection}>
        <header className={styles.header}>
          ...
          <div className={styles.headerRight}>
            ...
            <Button variant="contained" className={styles.containedBtn}>
              Start Free Trial
            </Button>
          </div>
        </header>
        <section className={styles.main}>
          <div className={styles.mainLeft}>
            <h1 className={styles.moto}>
              ...
              <br />
              for<span className={styles.React}> React developer</span>
            </h1>
            <p>
              The easiest way to build React landing page in seconds.
              <br />
              Save you time and focus on your product.
            </p>
            <TextField
              id="outlines-basic"
              variant="outlined"
      ...
      <Container className={styles.thirdSection} maxWidth="xl">
        <div className={styles.tsLeft}>
          ...
          <p>
            ...
            pulvinar libero enim, vel egestas odio rutrum sit amet. In a elit
            mollis, feugiat tortor quis, feugiat purus. Vestibulum condimentum
            neque quis arcu blandit facilisis.
          </p>
          <div className={styles.item}>
            <ViewInArIcon className={styles.tsIcons} fontSize="large" />
            <p>
              <span className={styles.smolHeading}>Your title here</span>
              <br />
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus
              pulvinar libero enim, vel egestas odio rutrum sit amet.
            </p>
          </div>
          <div className={styles.item}>
            <ViewInArIcon className={styles.tsIcons} fontSize="large" />
        ...
        <div className={styles.fourRight}>
          ...
          <div className={styles.nestedFlex}>
            <div className={styles.fourItems}>
              ...
              <p className={styles.fourItemText}>
      ...
      <Container className={styles.fifthSection} maxWidth="xl">
        <div className={styles.fifthTop}>
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus
            pulvinar libero enim, vel egestas odio rutrum sit amet.consectetur
            adipiscing elit.
          </p>
          <br />
        </div>
        <div className={styles.fifthBottom}>
          <section>
            <div className={styles.fifthTest}>
              <ViewInArIcon className={styles.tsIcons} fontSize="large" />
              <p className={styles.fifthItemText}>
                <span className={styles.fifthHeading}>Your title here</span>
